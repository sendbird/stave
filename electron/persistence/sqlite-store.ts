...
export class SqliteStore {
  ...
  createNotification(args: {
    ...
    return this.notifications.createNotification(args);
  }
  ...
  listNotifications(args?: {
    ...
    return this.notifications.listNotifications(args);
  }
  ...
  markNotificationRead(args: {
    ...
    return this.notifications.markNotificationRead(args);
  }

  markAllNotificationsRead(args?: { readAt?: string }): number {
    return this.notifications.markAllNotificationsRead(args);
  }

  pruneNotifications(args?: { now?: string }): number {
    return this.notifications.pruneNotifications(args);
  }

  deleteNotificationsForWorkspaces(args: { workspaceIds: string[] }): number {
    return this.notifications.deleteNotificationsForWorkspaces(args);
  }

  deleteOrphanedNotifications(): { count: number; workspaceIds: string[] } {
    return this.notifications.deleteOrphanedNotifications();
  }

  clearNotificationHistory(): number {
    return this.notifications.clearNotificationHistory();
  }
