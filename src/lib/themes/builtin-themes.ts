...
const PRESET_EXTENDED_THEME_TOKENS: Record<ThemeModeName, Record<ExtendedThemeTokenName, string>> = {
  light: {
    ...
    "drop-zone": "oklch(0.532 0.157 131.589 / 0.12)",
    "drop-zone-border": "oklch(0.532 0.157 131.589 / 0.55)",
  ...
  dark: {
    ...
    "drop-zone": "oklch(0.768 0.233 130.85 / 0.16)",
    "drop-zone-border": "oklch(0.768 0.233 130.85 / 0.6)",
