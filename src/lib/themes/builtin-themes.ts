...
> = {
  light: {
    ...
    "provider-cursor": "oklch(0.38 0.028 94)",
    "provider-kiro": "oklch(0.54 0.18 296)",
  ...
  dark: {
    ...
    "provider-cursor": "oklch(0.86 0.018 94)",
    "provider-kiro": "oklch(0.72 0.16 296)",
...
const AYU_DARK = createBuiltinTheme({
  ...
  overrides: {
    ...
    primary: "#E6B450",
    "primary-foreground": "#765B24",
    secondary: "#1B1F29",
    "secondary-foreground": "#BFBDB6",
    muted: "#1B1F29",
    "muted-foreground": "#888D95",
    accent: "#47526646",
    ...
    "sidebar-primary-foreground": "#765B24",
    "sidebar-accent": "#47526633",
    ...
    warning: "#FFB454",
    "warning-foreground": "#765B24",
    info: "#39BAE6",
    "info-foreground": "#10141C",
    overlay: "#10141CE6",
    surface: "#141821",
    "drop-zone": "#E6B45029",
    "drop-zone-border": "#E6B45099",
    editor: "#10141C",
    "editor-foreground": "#BFBDB6",
    "editor-muted": "#0D1017",
    "editor-tab": "#0D1017",
    "editor-tab-active": "#10141C",
    terminal: "#0D1017",
    "terminal-foreground": "#BFBDB6",
    "diff-added": "#70BF561F",
    "diff-added-foreground": "#AAD94C",
    "diff-removed": "#F26D781F",
    "diff-removed-foreground": "#F07178",
    "chart-1": "#E6B450",
    "chart-2": "#59C2FF",
    "chart-3": "#AAD94C",
    "chart-4": "#F07178",
    "chart-5": "#D2A6FF",
    "provider-codex": "#59C2FF",
    "provider-claude": "#F29668",
  },
});
...
const SELENIZED_LIGHT = createBuiltinTheme({
  ...
  overrides: {
    ...
    ring: "#0072D4",
    sidebar: "#ECE3CC",
    "sidebar-foreground": "#3A4D53",
    "sidebar-primary": "#0072D4",
    "sidebar-primary-foreground": "#FBF3DB",
    "sidebar-accent": "#D5CDB6",
    "sidebar-accent-foreground": "#3A4D53",
    "sidebar-border": "#909995",
    "sidebar-ring": "#0072D4",
    success: "#317A00",
    ...
    surface: "#ECE3CC",
    "drop-zone": "#0072D41F",
    "drop-zone-border": "#0072D499",
    editor: "#FBF3DB",
    "editor-foreground": "#3A4D53",
    "editor-muted": "#ECE3CC",
    "editor-tab": "#ECE3CC",
    "editor-tab-active": "#FBF3DB",
    terminal: "#FBF3DB",
    "terminal-foreground": "#3A4D53",
    "diff-added": "#48910026",
    "diff-added-foreground": "#1F6900",
    "diff-removed": "#D2212D26",
    "diff-removed-foreground": "#B2000D",
    "chart-1": "#0072D4",
    "chart-2": "#009C8F",
    "chart-3": "#489100",
    "chart-4": "#C25D1E",
    "chart-5": "#CA4898",
    "provider-codex": "#0072D4",
    "provider-claude": "#C25D1E",
  },
});
...
const MODUS_OPERANDI_TINTED = createBuiltinTheme({
  ...
  overrides: {
    ...
    sidebar: "#EFE9DD",
    "sidebar-foreground": "#000000",
    "sidebar-primary": "#0031A9",
    "sidebar-primary-foreground": "#FBF7F0",
    "sidebar-accent": "#C9B9B0",
    "sidebar-accent-foreground": "#000000",
    "sidebar-border": "#9F9690",
    "sidebar-ring": "#0031A9",
    success: "#006300",
    "success-foreground": "#FBF7F0",
    warning: "#6D5000",
    "warning-foreground": "#FBF7F0",
    info: "#00598B",
    "info-foreground": "#FBF7F0",
    overlay: "#00000099",
    surface: "#EFE9DD",
    "drop-zone": "#0031A91F",
    "drop-zone-border": "#0031A999",
    editor: "#FBF7F0",
    "editor-foreground": "#000000",
    "editor-muted": "#EFE9DD",
    "editor-tab": "#E0D4CE",
    "editor-tab-active": "#FBF7F0",
    terminal: "#FBF7F0",
    "terminal-foreground": "#000000",
    "diff-added": "#C3EBC1",
    "diff-added-foreground": "#005000",
    "diff-removed": "#F4D0CF",
    "diff-removed-foreground": "#8F1313",
    "chart-1": "#0031A9",
    "chart-2": "#00598B",
    "chart-3": "#006300",
    "chart-4": "#6D5000",
    "chart-5": "#721045",
    "provider-codex": "#0031A9",
    "provider-claude": "#721045",
  },
});
...
const SELENIZED_DARK = createBuiltinTheme({
  ...
  overrides: {
    ...
    ring: "#4695F7",
    sidebar: "#103C48",
    "sidebar-foreground": "#CAD8D9",
    "sidebar-primary": "#4695F7",
    "sidebar-primary-foreground": "#103C48",
    "sidebar-accent": "#2D5B69",
    "sidebar-accent-foreground": "#CAD8D9",
    "sidebar-border": "#2D5B69",
    "sidebar-ring": "#4695F7",
    success: "#7EC242",
    "success-foreground": "#103C48",
    warning: "#DBB32D",
    "warning-foreground": "#103C48",
    info: "#41C7B9",
    "info-foreground": "#103C48",
    overlay: "#103C48E6",
    surface: "#184956",
    "drop-zone": "#4695F729",
    "drop-zone-border": "#4695F799",
    editor: "#103C48",
    "editor-foreground": "#CAD8D9",
    "editor-muted": "#184956",
    "editor-tab": "#103C48",
    "editor-tab-active": "#184956",
    terminal: "#103C48",
    "terminal-foreground": "#CAD8D9",
    "diff-added": "#75B93826",
    "diff-added-foreground": "#93D85A",
    "diff-removed": "#FA575026",
    "diff-removed-foreground": "#FF9D90",
    "chart-1": "#4695F7",
    "chart-2": "#41C7B9",
    "chart-3": "#75B938",
    "chart-4": "#ED8649",
    "chart-5": "#F275BE",
    "provider-codex": "#4695F7",
    "provider-claude": "#ED8649",
  },
});
...
const MODUS_VIVENDI_TINTED = createBuiltinTheme({
  ...
  overrides: {
    ...
    "accent-foreground": "#FFFFFF",
    destructive: "#FF5F59",
    "destructive-foreground": "#0D0E1C",
    border: "#61647A",
    input: "#0D0E1C",
    ring: "#2FAFFF",
    sidebar: "#0D0E1C",
    "sidebar-foreground": "#FFFFFF",
    "sidebar-primary": "#2FAFFF",
    "sidebar-primary-foreground": "#0D0E1C",
    "sidebar-accent": "#4A4F69",
    "sidebar-accent-foreground": "#FFFFFF",
    "sidebar-border": "#61647A",
    "sidebar-ring": "#2FAFFF",
    success: "#44BC44",
    "success-foreground": "#0D0E1C",
    warning: "#D0BC00",
    "warning-foreground": "#0D0E1C",
    info: "#00D3D0",
    "info-foreground": "#0D0E1C",
    overlay: "#0D0E1CE6",
    surface: "#1D2235",
    "drop-zone": "#2FAFFF29",
    "drop-zone-border": "#2FAFFF99",
    editor: "#0D0E1C",
    "editor-foreground": "#FFFFFF",
    "editor-muted": "#1D2235",
    "editor-tab": "#2C3045",
    "editor-tab-active": "#0D0E1C",
    terminal: "#0D0E1C",
    "terminal-foreground": "#FFFFFF",
    "diff-added": "#003A2F",
    "diff-added-foreground": "#A0E0A0",
    "diff-removed": "#4F1127",
    "diff-removed-foreground": "#FFBFBF",
    "chart-1": "#2FAFFF",
    "chart-2": "#00D3D0",
    "chart-3": "#44BC44",
    "chart-4": "#D0BC00",
    "chart-5": "#FEACD0",
    "provider-codex": "#2FAFFF",
    "provider-claude": "#FEACD0",
  },
});
