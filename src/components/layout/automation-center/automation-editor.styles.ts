...
export const editorStyles = stylex.create({
  ...
  sectionDetail: { color: vars.colorTextMuted, fontSize: vars.fontSizeMicro },
  sectionDescription: {
    color: vars.colorTextMuted,
  ...
  headerSubtitle: { color: vars.colorTextMuted, fontSize: vars.fontSizeMicro },
  ...
  loadingNote: { color: vars.colorTextMuted, fontSize: vars.fontSizeMicro },
