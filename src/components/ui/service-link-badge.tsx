...
function FigmaBadgeIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 38 57" aria-hidden="true" className={cn("h-[1em] w-auto shrink-0", className)}>
...
function JiraBadgeIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" className={cn("h-[1em] w-[1em] shrink-0", className)}>
      <path
        fill="#2684ff"
...
function ConfluenceBadgeIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" className={cn("h-[1em] w-[1em] shrink-0", className)}>
      <path
        fill="#2684ff"
...
export function ServiceLinkIcon({
  kind,
  className,
}: {
  ...
  const Icon = SERVICE_BADGE_ICONS[kind];
