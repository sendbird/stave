...
header: {borderBottomWidth:1,borderBottomStyle:"solid",borderBottomColor:vars["--ads-color-border"],padding:20,paddingRight:56},
heading: {display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:12},
content: {minWidth:0},
title: {fontSize: vars["--ads-font-size-lead"]},
description: {marginTop:8,lineHeight:"20px"},
current: {flexShrink:0,borderRadius:6,borderWidth:1,borderStyle:"solid",borderColor:vars["--ads-color-border"],paddingInline:8,paddingBlock:4,fontSize: vars["--ads-font-size-caption"],color:vars["--ads-color-text-muted"]},
rows: {display:"flex",flexDirection:"column",gap:12,paddingInline:20,paddingBlock:16},
empty: {borderRadius:6,borderWidth:1,borderStyle:"dashed",borderColor:vars["--ads-color-border"],backgroundColor:vars["--ads-color-canvas-subtle"],padding:12,fontSize: vars["--ads-font-size-body"],color:vars["--ads-color-text-muted"]},
note: {fontSize: vars["--ads-font-size-caption"],lineHeight:"20px",color:vars["--ads-color-text-muted"]},
footer: {borderTopWidth:1,borderTopStyle:"solid",borderTopColor:vars["--ads-color-border"],paddingInline:20,paddingBlock:16},
row: {borderRadius:6,borderWidth:1,borderStyle:"solid",borderColor:vars["--ads-color-border"],backgroundColor:vars["--ads-color-canvas"],paddingInline:12,paddingBlock:8},
rowHeader: {display:"flex",alignItems:"center",justifyContent:"space-between",gap:12},
rowLabel: {fontSize: vars["--ads-font-size-micro"],textTransform:"uppercase",letterSpacing:"0.025em",color:vars["--ads-color-text-muted"]},
provider: {borderRadius:6,borderWidth:1,borderStyle:"solid",borderColor:vars["--ads-color-border"],paddingInline:8,paddingBlock:4,fontSize: vars["--ads-font-size-caption"],color:vars["--ads-color-text-muted"]},
valueRow: {marginTop:4,display:"flex",alignItems:"center",justifyContent:"space-between",gap:12},
value: {minWidth:0,flex:1,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",fontFamily:vars["--ads-font-mono"],fontSize: vars["--ads-font-size-body"],color:vars["--ads-color-text"]},
