...
content: {minWidth:0},
title: {fontSize: vars.fontSizeLead},
description: {marginTop:8,lineHeight:"20px"},
current: {flexShrink:0,borderRadius:6,borderWidth:1,borderStyle:"solid",borderColor:vars.colorBorder,paddingInline:8,paddingBlock:4,fontSize: vars.fontSizeCaption,color:vars.colorTextMuted},
rows: {display:"flex",flexDirection:"column",gap:12,paddingInline:20,paddingBlock:16},
empty: {borderRadius:6,borderWidth:1,borderStyle:"dashed",borderColor:vars.colorBorder,backgroundColor:vars.colorCanvasSubtle,padding:12,fontSize: vars.fontSizeBody,color:vars.colorTextMuted},
note: {fontSize: vars.fontSizeCaption,lineHeight:"20px",color:vars.colorTextMuted},
...
rowLabel: {fontSize: vars.fontSizeMicro,textTransform:"uppercase",letterSpacing:"0.025em",color:vars.colorTextMuted},
provider: {borderRadius:6,borderWidth:1,borderStyle:"solid",borderColor:vars.colorBorder,paddingInline:8,paddingBlock:4,fontSize: vars.fontSizeCaption,color:vars.colorTextMuted},
valueRow: {marginTop:4,display:"flex",alignItems:"center",justifyContent:"space-between",gap:12},
value: {minWidth:0,flex:1,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",fontFamily:vars.fontMono,fontSize: vars.fontSizeBody,color:vars.colorText},
