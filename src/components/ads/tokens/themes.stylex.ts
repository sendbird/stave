...
export const darkTheme = stylex.createTheme(vars, {
  ...
  colorDiffAdded: "oklch(0.3 0.06 152)",
  colorDiffAddedText: "oklch(0.83 0.16 152)",
  colorDiffRemoved: "oklch(0.3 0.06 30)",
  colorDiffRemovedText: "oklch(0.885 0.058 30)",
...
export const highContrastTheme = stylex.createTheme(vars, {
  ...
  colorDiffAdded: "oklch(0.962 0.045 152)",
  colorDiffAddedText: "oklch(0.345 0.08 152)",
  colorDiffRemoved: "oklch(0.97 0.007 89)",
  colorDiffRemovedText: "oklch(0.396 0.141 30)",
