...
const styles = stylex.create({
  ...
  zoomReadout: {
    minInlineSize: vars["--ads-control-height-lg"],
  },
  stage: {
    alignItems: "center",
    ...
    paddingInline: {
      default: vars["--ads-space-64"],
      "@media (max-width: 640px)": vars["--ads-space-16"],
    },
    position: "relative",
  },
  mediaSurface: {
  ...
  next: {
    insetBlockStart: "50%",
    insetInlineEnd: vars["--ads-space-16"],
    position: "absolute",
    transform: "translateY(-50%)",
  },
  caption: {
    ...
    marginBlockStart: 0,
    marginInline: "auto",
    maxInlineSize: `min(640px, calc(100dvw - ${vars["--ads-space-32"]}))`,
